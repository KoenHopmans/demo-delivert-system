...
//         <img className="music-player-tv__img" id="music-player-tv__img" src={MusicPlayerImg}
//         alt="Music Player" />
...
//           <button type="button" id="action-btn--prev"
//           className="music-player__action-btn music-player__action-btn--prev">
//             <span className="fas fa-backward md-20" />
//           </button>
//           <button type="button" id="action-btn--play"
//           className="music-player__action-btn music-player__action-btn--play">
//             <span className="fas fa-play md-20" />
//           </button>
//           <button type="button" id="action-btn--next"
//           className="music-player__action-btn music-player__action-btn--next">
